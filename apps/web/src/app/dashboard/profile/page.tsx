...
const ProfilePage: React.FC = () => {
  ...
  const handleChangePassword = async () => {
    ...
    try {
      const { data } = await connectApi.patch('/profile', {
              ...
              <div className="lg:col-span-1 space-y-6">
                <div className="p-8 rounded-4xl bg-white/3 border border-white/5 flex flex-col items-center text-center">
                  <div className="relative mb-6">
                    <div className="w-32 h-32 rounded-full bg-purple-600/20 border border-purple-500/20 flex items-center justify-center overflow-hidden shadow-2xl">
                      <Image
                  ...
                  <p className="text-white/20 text-xs mt-1 font-medium">
                    {formData.email}
                  </p>
                  <div className="mb-6" />
                ...
                <div className="p-6 rounded-3xl bg-yellow-500/5 border border-yellow-500/10">
                  ...
                  <p className="text-xs text-yellow-500/40 leading-relaxed italic">
                    {isPro
                      ? 'Nikmati akses tanpa batas ke semua katalog movie, serial, dan anime chill.'
                      : 'Upgrade ke Pro untuk menikmati movie tanpa iklan dan kualitas 4K HDR.'}
                  </p>
                </div>
              </div>
                ...
                <div className="pt-8 border-t border-white/5">
                  <div className="flex flex-col md:flex-row items-start gap-6">
                    <div className="w-full md:flex-1 p-6 rounded-3xl bg-white/2 border border-white/5">
                      <div className="px-1 text-[10px] font-semibold uppercase tracking-widest text-purple-400 mb-3">
                        Ubah Kata Sandi
                      </div>
                      <div className="space-y-5">
                        <div className="space-y-0">
                          <label className="text-[10px] font-semibold uppercase tracking-widest text-white/20 ml-1">
                            Password Baru
                          </label>
                          <input
                            type="password"
                    ...
                    <div className="flex flex-col gap-4 w-full md:flex-1">
                      <div className="p-6 rounded-3xl bg-white/2 border border-white/5">
                        <h4 className="text-[10px] font-semibold uppercase tracking-widest text-purple-400 mb-3">
                          Member Since
                        </h4>
                        ...
                        <div className="p-6 rounded-3xl bg-white/2 border border-white/5 mt-4">
                          ...
                          <div className="space-y-4">
                            <div>
                              ...
                              <p className="text-sm font-semibold text-white/80">
                                {user.subscription.package?.name || 'Essential'}
                              </p>
                            </div>
                            <div>
                              <p className="text-[10px] font-semibold text-white/20 uppercase tracking-widest mb-2">
                              ...
                              <p className="text-sm font-semibold text-white/80">
                                {(user.subscription as any).createdAt
                                  ? new Date(
                                      (user.subscription as any).createdAt,
