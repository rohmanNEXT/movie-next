      ...
      : "px-6 md:px-12 lg:px-20 xl:px-28 py-4 md:py-5"
        ...
        >
          ...
          <div className="flex items-center gap-4 md:gap-8">
            ...
            >
              <div className="bg-purple-500/70 p-1 md:p-1.5 rounded-lg cursor-pointer">
                <LuPlay className="fill-white md:w-5 md:h-5" size={16} />
              </div>
              Chill
            </Link>
          ...
          <div className="flex items-center gap-3 md:gap-4">
            ...
            >
              <LuSearch size={18} className="md:w-5 md:h-5" />
            </button>
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <div className="bg-purple-500/70 p-1 rounded-lg">
                    <LuPlay size={14} className="fill-white" />
                  </div>
                  Chill
                </Link>
                <button
          ...
          <div className="fixed inset-0 z-100 flex items-start justify-center pt-24 px-4">
            ...
            >
              <div className="flex items-center gap-4">
                <LuSearch className="text-gray-400 cursor-pointer" size={18} />
                <input
                  autoFocus
                  type="text"
                  value={searchTerm}
