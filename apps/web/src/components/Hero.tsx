...
const Hero: React.FC<HeroProps> = ({ movies }) => {
  ...
  return (
    <div
      ref={heroRef}
      className="relative h-[96vh] w-full overflow-hidden bg-black"
    >
      ...
      <div className="absolute bottom-20 md:bottom-28 left-6 md:left-12 lg:left-20 xl:left-28 right-6 md:right-auto max-w-2xl space-y-6 z-20">
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-xs md:text-sm text-white/50 line-clamp-2 md:line-clamp-1 mb-6 leading-relaxed max-w-md md:max-w-lg drop-shadow-md font-medium">
              {movie.description || ''}
            </p>
