...
export class AuthRouter {
  ...
  private initializeRoutes(): void {
    ...
    this.router.get('/me', verifyToken, this.authController.getMe.bind(this.authController));
    this.router.post('/keep-login', verifyToken, this.authController.keepLogin.bind(this.authController));
  }
