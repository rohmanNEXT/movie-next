...
Semua akun memiliki saldo awal **Rp 4.000.000**.

email - password

* `superadmin@superadmin.com` - `superadmin123`
* `admin@admin.com` - `admin123`
* `user@user.com` - `user123` (user pertama)
* `user2@user.com` - `user2-123`

### Contoh Data Seed

- **Superadmin** mengupload 6 film dengan poster lokal dari `public/film/`
- **Admin** mengupload 4 film dengan poster lokal dari `public/film/`
- **user2@user.com** mendaftar dengan referral dari `user@user.com` dan sudah berlangganan paket Essential, sehingga user pertama menerima komisi referral
- Profile image konsisten per user ID (6 avatar di `public/img/`, tampil di sidebar & navbar)
